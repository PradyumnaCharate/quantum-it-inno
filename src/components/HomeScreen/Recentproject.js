                      ...
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid fix-height" src="https://quantumitinnovation.com/assets/images/portfolio/w1.png" alt="title" />
                          </div>
                        </div>
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/w2.png" alt="title" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/w3.png" alt="hjh" />
                          </div>
                        </div>
                        <div className="content">
                      ...
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image text-center">
                            <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m1.png" alt="ujyhgiu" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image text-center">
                            <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m2.png" alt="fgdfg" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image text-center">
                            <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m3.png" alt="jmhjhg" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d1.jpg" alt="rtret" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d2.jpg" alt="fds" />
                          </div>
                        </div>
                        <div className="content">
                  ...
                  <div className="col-lg-4 col-md-6">
                    ...
                    <a href="#" className="ht-large-box-images style-04">
                      <div className="large-image-box">
                        <div className="box-image">
                          <div className="default-image port_img_box">
                            <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d3.jpg" alt="hgrh" />
                          </div>
                        </div>
                        <div className="content">
