              ...
              <div className="carousel-caption text-left">
                <div className="animated fadeInDown">
                  ...
                  <div className="button_cont">
                    <Link className="banner_btn" to="/contactus" rel="nofollow noopener">Get A Quote</Link>
                  </div>
                </div>
              </div>
            </div>
            <div className="carousel-item ">
              ...
              <div className="carousel-caption text-left">
                ...
                <div className="animated fadeInDown">
                  ...
                  <div className="button_cont">
                    <a className="banner_btn" href="contact.html" rel="nofollow noopener">Get A Quote</a>
                  </div>
                </div>
              </div>
            </div>
