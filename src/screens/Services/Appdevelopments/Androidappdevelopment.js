...
<div>
  <div className="site-wrapper-reveal">
    ...
    <AndroidHero image={"https://quantumitinnovation.com/assets/img/service-images/a1.jpg"} title={["Launch Your", <br></br>,  "Android App With Us!"]} description={"We deliver mobile app experiences that get your mobile app trending on the apps stores."} />
    <div className="container-fluid">
      <div className="row">
        <div className="col-lg-5 col-md-5">
          <div className="top_sec">
            <h2>Android App Development Services</h2>
            <p className="mt-4 txt-algn"><strong>Quantum It Innovation</strong> is a leading Android app development company developed 100+ Android apps for all the latest versions of OS such as Android KitKat, Lollipop, Marshmallow, Oreo, etc. We helped companies transform their ideas into high-impact mobile apps that people love to use. We promise to deliver secure, efficient, fault-tolerant, and usable Apps on-time and on-budget with a meticulous combination of processes and tools. Our android apps are highly human-centric design. We develop apps that not only have the great design but integrating it perfectly with the backend makes the app an eye-catching product. We deliver it with highly skilled UI &amp; UX app designers and well-versed programmers.
            </p>
            <p className="mt-3 txt-algn">As per research, we have found for the statistics to analyze the importance of Mobile App Development in current World economic conditions:
            </p>
            <ol>
              <li>There are approx. 2.32 billion mobile users present worldwide in 2017 and will cross 3 billion by 2021.</li>
              <li>There are 3.6 million Android apps present in the Google Play Store until March 2018.</li>
              <li>There are 2 million apps available on the Apple app store at present.</li>
            </ol>
            <p className="mt-3 txt-algn" style={{textAlign: 'left !important'}}>Quantum offers android mobile app development, which has plenty of features such as providing excellent security to your personal and business data, comes with stunning and adaptive designs for all mobile screen sizes, optimized memory, compatibility to all mobile devices and reliability. 
            </p>
          </div>    
        </div>
        <div className="col-lg-7 col-md-7 plr-30">
      ...
      <h5 className="text-center mb-5">OUR INTEGRATIONS POWER YOUR APPS, <br /> ROCKETING THEM TO THE NEXT LEVEL</h5>
      ...
      <div className="container meth-section mt-2">
        <h5 className="text-center mb-5">Our App Development Methodology</h5>
        <div className="row">
      ...
      <div className="container mt-5">
        <div className="content mb-5">
          <h5 className="text-center mb-5">Our Android App Development Company Approaches</h5>
          <p>The Native Android app is a specific device platform, it is directly installed on mobile devices and developers need to create a separate version for each device. 
          ...
          <h6>Hybrid Android App Development</h6>
          <p style={{textAlign: 'left!important'}}>Hybrid apps, such as web apps, you install it like a Native app. Hybrid apps are built with standard web technologies like JavaScript, HTML5, and CSS. 
          ...
          <p style={{textAlign: 'left!important'}}>Both of the above mentioned Native and Hybrid app development approaches have their own pros and cons. 
                        ...
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/w1.png" alt />
                            </div>
                          </div>
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/w2.png" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/w3.png" alt />
                            </div>
                          </div>
                          <div className="content">
                        ...
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image text-center">
                              <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m1.png" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image text-center">
                              <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m2.png" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image text-center">
                              <img className="img-phone" src="https://quantumitinnovation.com/assets/images/portfolio/m3.png" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d1.jpg" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d2.jpg" alt />
                            </div>
                          </div>
                          <div className="content">
                    ...
                    <div className="col-lg-4 col-md-6">
                      ...
                      <a href="#" className="ht-large-box-images style-04">
                        <div className="large-image-box">
                          <div className="box-image">
                            <div className="default-image port_img_box">
                              <img className="img-fluid" src="https://quantumitinnovation.com/assets/images/portfolio/d3.jpg" alt />
                            </div>
                          </div>
                          <div className="content">
    ...
    <div className="why-choose-us mt-5" style={{backgroundImage: 'url(https://quantumitinnovation.com/assets/img/Group-new.png)'}}>
      <div className="container pb-5">
        <h5 className="text-center clr-wht pt-5">Why Choose Quantum for Android App Development Services?</h5>
        <div className="row">
          <div className="col-lg-6 col-md-6 mt-5">
            <div id="accordion">
              <div className="card cust-card ">
                ...
                <a className="card-link" data-toggle="collapse" href="#collapseOne">
                  <i className="fa fa-plus" aria-hidden="true" /> Customer-Centric Process
                </a>
                {/*</div>*/}
                <div id="collapseOne" className="collapse" data-parent="#accordion">
                  <div className="card-body">
                    We offer efficient, tailored solutions for your business and a transparent work-flow, allowing all our clients access to the project under development with regular updates.
                  </div>
                </div>
              </div>
              <div className="card cust-card ">
                ...
                <a className="collapsed card-link" data-toggle="collapse" href="#collapseTwo">
                  <i className="fa fa-plus" aria-hidden="true" /> Third Party SDK Integrations
                </a>
                {/*</div>*/}
                <div id="collapseTwo" className="collapse" data-parent="#accordion">
                  <div className="card-body">
                    Android, being a popular OS, has a large catalog of external APIs.
                  </div>
                </div>
              </div>
              <div className="card cust-card ">
                ...
                <a className="collapsed card-link" data-toggle="collapse" href="#collapseThree">
                  <i className="fa fa-plus" aria-hidden="true" /> Comprehensive App Testing &amp; Support
                </a>
                {/*</div>*/}
                <div id="collapseThree" className="collapse" data-parent="#accordion">
                  <div className="card-body">
                    We check and test the final version of the app for cross-platform compatibility, graphics, navigation, and user experience, overall quality to ensure a perfect and bug-free app.
                  </div>
                </div>
              </div>
            </div>
            ...
            <div id="accordion">
              <div className="card cust-card ">
                ...
                <a className="card-link" data-toggle="collapse" href="#collapseSeven">
                  <i className="fa fa-plus" aria-hidden="true" /> Strict Adherence to Development Guidelines 
                </a>
                {/*</div>*/}
                <div id="collapseSeven" className="collapse" data-parent="#accordion">
                  <div className="card-body">
                    From app development consultations and discussions to final delivery, we at Quantum believe in laying down ground rules at offset for the entire project.
                  </div>
                </div>
              </div>
              <div className="card cust-card">
                ...
                <a className="collapsed card-link" data-toggle="collapse" href="#collapseEight">
                  <i className="fa fa-plus" aria-hidden="true" />Cost Effective Service 
                </a>
                {/*</div>*/}
                <div id="collapseEight" className="collapse" data-parent="#accordion">
                  <div className="card-body">
                    We firmly believe in customer satisfaction and apart from offering Affordable prices we also work towards developing custom payment options for all our clients.    
                  </div>
                </div>
              </div>
            </div>
