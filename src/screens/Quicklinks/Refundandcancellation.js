...
function Refundandcancellation() {
  return (
   <div>   <div className="container pt-5">
    ...
    <h5 className="mt-3 mb-2">Refund Policy</h5>    
    <ul style={{listStyleType: 'disc'}}>
    ...
    <p className="pb-5 pt-2"><strong>Sales/ Support:</strong> email: sales@quantumitinnovation.com Cell: + 91 11 4328 2001 or + 1 877 877 3644.</p>
  </div></div>
