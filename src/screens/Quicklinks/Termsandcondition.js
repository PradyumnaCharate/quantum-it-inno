...
function Termsandcondition() {
  ...
  <div className="container pt-5">
    <h5 className="text-center">TERMS AND CONDITION</h5>
    <p className="mt-3">We do not collect personally identifiable information about you unless you choose to fill your personal information on our website.
    ...
    <p className="pb-5"><strong>Sales/ Support:</strong> email: sales@quantumitinnovation.com Cell: + 91 11 4328 2001 or + 1 877 877 3644.</p>
  </div>
</div>
