...
function Privacypolicy() {
 ...
 <div>
  <div className="container pt-5">
    ...
    <ul style={{listStyleType: 'disc'}}>We may collect, store and use the following types of information:
    ...
    <h5 className="mt-3 mb-2">What we do with the information we gather</h5>
    ...
    <h5 className="mt-3 mb-2">Security</h5>
    ...
    <p className="pb-5">If you believe that any information we are holding on you is incorrect or incomplete, please write to or email us as soon as possible at the above address. We will promptly correct any information found to be incorrect.</p>
  </div>
</div>
